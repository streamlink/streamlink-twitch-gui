define(function( require ) {
	...
	return Ember.Application.create({
		...
		FirstrunModalTemplate: require( "hbs!templates/modals/firstrun" ),
		ChangelogModalTemplate: require( "hbs!templates/modals/changelog" ),
		NewreleaseModalTemplate: require( "hbs!templates/modals/newrelease" ),
		SettingsModalTemplate: require( "hbs!templates/modals/settings" ),
		LivestreamerModalTemplate: require( "hbs!templates/modals/livestreamer" ),
		QuitModalTemplate: require( "hbs!templates/modals/quit" ),
		...
		ChannelIndexTemplate: require( "hbs!templates/channel/index" ),
		...
		ChannelSettingsTemplate: require( "hbs!templates/channel/settings" ),
		...
		UserIndexTemplate: require( "hbs!templates/user/index" ),
		UserAuthRoute: require( "routes/UserAuthRoute" ),
		UserAuthController: require( "controllers/UserAuthController" ),
		UserAuthTemplate: require( "hbs!templates/user/auth" ),
		UserSubscriptionsRoute: require( "routes/UserSubscriptionsRoute" ),
		UserSubscriptionsTemplate: require( "hbs!templates/user/subscriptions" ),
		UserFollowedStreamsRoute: require( "routes/UserFollowedStreamsRoute" ),
		UserFollowedStreamsTemplate: require( "hbs!templates/user/followedstreams" ),
		...
		UserFollowedChannelsTemplate: require( "hbs!templates/user/followedchannels" ),
		UserFollowedGamesRoute: require( "routes/UserFollowedGamesRoute" ),
		UserFollowedGamesTemplate: require( "hbs!templates/user/followedgames" ),
